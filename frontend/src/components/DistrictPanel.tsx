  ...
  return <aside className="district-panel" aria-label="Районы и слои">
    ...
    <details open>
      ...
      <div className="panel-section layer-list">
        ...
        <p>Шум: дорожный слой показывает оценочный потенциал влияния (низкий / средний / высокий) по классу дороги и полосам. Железнодорожный слой показывает положение путей. Уровни дБ неизвестны; данные об авиационном и вертолётном шуме отсутствуют.</p>
      </div>
    </details>
  </aside>;
}
