...
SOURCE = SourceDefinition(
    id="test-fixture",
    name="Explicit ingestion test fixture",
    type="fixture",
    url="local://backend/app/ingestion/test_importer.py",
    license="project fixture",
    attribution="KARTASPB test fixture",
    notes="Non-production synthetic acceptance record",
)
    ...
    records = [
        (
            ...
            ImportRecord(
                ...
                name="Тестовый объект ingestion",
                category_id="demo",
                geometry={"type": "Point", "coordinates": [30.3158, 59.9391]},
